	...
	$.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
					...
					if ($li.children(self.options.listType).length) {
						...
						if ( !hasCollapsedClass && !hasExpandedClass ) {
							if (self.options.startCollapsed) {
								...
								$li.addClass(self.options.hasChildClass);
							}
						}
					} else {
								...
								if ( !$(itemElement).children(o.listType).length) {
									...
									if (o.isTree) {
										$(itemElement)
											...
											.addClass(o.branchClass + " " + o.hasChildClass);
									}
								}
			...
			if (parentItem != null &&
				...
				if (o.isTree && helperIsNotSibling) {
					parentItem
						...
						.removeClass(this.options.branchClass + " " + this.options.hasChildClass)
		...
		_clearEmpty: function (item) {
			...
			if (!doNotClear) {
				...
				childrenList.parent().removeClass(o.hasChildClass);
				childrenList.remove();
			}
		},
